...
public class HandEvaluatorTest {
    ...
    public void testTwoPair()
    {
        ...
        Hand testHand = new Hand();
          ...
          testHand.add(new Card("Spades",2));   
          testHand.add(new Card("Hearts",3));
          testHand.add(new Card("Spades",3));
    ...
    public void testDrawPairs()
    {
        ...
        Hand testHand2= new Hand();
          ...
          testHand.add(new Card("Spades",4));   
          testHand.add(new Card("Hearts",6));
          testHand.add(new Card("Spades",6));
          testHand.add(new Card("Hearts",9));
          testHand.add(new Card("Clubs",3));
          
    
          testHand2.add(new Card("Spades",6));   
          testHand2.add(new Card("Hearts",6));
          testHand2.add(new Card("Spades",5));
          testHand2.add(new Card("Hearts",2));
          testHand2.add(new Card("Clubs",3));
          
       dealer.setCards(testHand);
       player.setCards(testHand2);
          
        String actualValue = HandEvaluator.drawnHand(1, dealer, player);
        assertEquals("This is incorrect",expected, actualValue);
    }
}
